...
<body>
   <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color:rgb(183, 244, 183);">
     CRUD APPLICATION
   </nav> 
   ...
   <div class="container">
    <div class="text-center mb-4">
        <h3>LOGIN</h3>
        <p class="text-muted">Full the form to add a new user</p>
    </div>
